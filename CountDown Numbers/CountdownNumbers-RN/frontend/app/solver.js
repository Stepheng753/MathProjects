import { permutations, product } from './itertools';
...
export function arithmetic(arr) {
	let answer = arr[0];
	...
	return !Number.isInteger(answer) || answer < 0 ? null : answer;
}

export function loops(numbers, targetNumber) {
	let operations = ['+', '-', '*', '/'];
	let solutionsArr = [];
